...
const Navbar = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Pressable
        style={styles.pressableButton}
        onPress={() => navigation.navigate('GestionDonnées')}>
        <Text style={styles.squat}> Gestion des sauvegardes </Text>
      </Pressable>
      <Pressable
        style={styles.pressableButton}
        onPress={() => navigation.navigate('Configuration')}>
        <Text style={styles.squat}> config </Text>
      </Pressable>
      <Pressable
        style={styles.pressableButton}
        onPress={() => navigation.navigate('Analyse')}>
        <Text style={styles.squat}> Analyse </Text>
      </Pressable>
    </View>
  );
};
